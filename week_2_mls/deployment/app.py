...
model_path = hf_hub_download(repo_id="Verallon/Machine-Failure-Prediction", filename="best_machine_failure_model_v1.joblib")
model = joblib.load(model_path)

st.title("Machine Failure Prediction App")
st.write("""This app predicts whether a machine will fail based on its operational data.""")
