...
############################################################################################
DATASET_PATH = "/content/week_2_mls/data/machine-failure-prediction.csv" # on local drive

#from huggingface_hub import HfApi, HfFolder, Repository, create_repo, upload_file
#HfFolder no longer exists in the newer version of the huggingface_hub library.
from huggingface_hub import HfApi, create_repo

api = HfApi()
api.upload_file(
    path_or_fileobj="/content/week_2_mls/data/machine-failure-prediction.csv",
